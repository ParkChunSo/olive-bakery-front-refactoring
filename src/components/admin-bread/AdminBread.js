...
import AdminProductsModal from "./AdminBreadModal";
import BreadStateModal from "./BreadStateModal";
...
class AdminBread extends React.Component {
    state = {
        isCreating: false,
        ingredients: [],
        bread: [],
...
export default withStyles(styles)(AdminBread);
